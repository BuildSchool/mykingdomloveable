...
export const ExperienceFutureSection = () => {
  return (
    <section className="py-20 bg-gradient-to-b from-[#1a237e] to-[#0d47a1] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className="glass-card p-8 rounded-2xl flex flex-col items-center text-center group hover:scale-105 transition-transform duration-300 border border-white/10 backdrop-blur-lg"
            >
        ...
        <div className="flex justify-center mt-12">
          <button className="relative px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full font-semibold transition-all duration-300 shadow-lg hover:shadow-blue-500/25 overflow-hidden group">
            {/* Animated background */}
