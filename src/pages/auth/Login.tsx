...
export const LoginForm = () => {
  ...
  // No need for separate handleGoogleSignIn as Auth component handles it
  ...
  return (
    <Auth
      ...
      redirectTo={`${window.location.origin}/auth/callback`} // Changed from /home to /auth/callback
      view="sign_in"
      showLinks={true}
      socialLayout="vertical"
      onlyThirdPartyProviders={true} // Changed to true since you're only using Google
    />
  );
};